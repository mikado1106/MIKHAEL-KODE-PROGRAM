...
<h3 class="mb-3">Pengajuan Pensiun</h3>
...
<div class="card">
    <div class="card-body">
        <form action="<?= site_url('/employee/exit/pension/submit') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="mt-3">
                ...
                <button class="btn btn-warning">Kirim Pengajuan Pensiun</button>
            </div>
        </form>
    </div>
</div>
